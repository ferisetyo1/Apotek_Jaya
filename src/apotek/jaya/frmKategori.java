...
public class frmKategori extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Daftar Kategori"));
        ...
        pPegawai.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Data Kategori"));
        pPegawai.setEnabled(false);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel1.setText("Kategori");

        eKategori.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(pPegawai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jSupplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSupplierMouseClicked
        ...
        ID = hasil;
        eKategori.setText((jSupplier.getModel().getValueAt(row, 0).toString()));
    ...
    private void showData() {
        ...
        try {
            ResultSet rs = preState("select * from kategori").executeQuery();
            while (rs.next()) {
                model.addRow(
                        new Object[]{
                            rs.getString(2)
    ...
    private void insertData() {
        try {
            PreparedStatement pst = con.prepareStatement("insert into kategori(Kategori) values(?)");
            pst.setString(1, eKategori.getText());
            pst.executeUpdate();
            showData();
    ...
    private void updateData() {
        try {
            PreparedStatement pst = con.prepareStatement("update kategori set Kategori=? where Kategori='" + ID + "'");
            pst.setString(1, eKategori.getText());
            pst.executeUpdate();
            showData();
    ...
    private void deleteData() {
        try {
            PreparedStatement pst = con.prepareStatement("delete from kategori where Kategori='" + ID + "'");
            pst.executeUpdate();
            showData();
